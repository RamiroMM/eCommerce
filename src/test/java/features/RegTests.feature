...
@RegTest1
Scenario Outline: Verify the breadcrumb of the SKU PDP
...
@RegTest1
Scenario Outline: Verify the number of h1 tags in PDP
Given User is on StoreFront homepage with <link>
And User searches and opens "DL380"
When User clicks on services tab
And User opens first services product
...
@RegTest
Scenario Outline: Verify the Quickspec link in PDP
Given User is on StoreFront homepage with <link>
And User searches and opens "DL380"
